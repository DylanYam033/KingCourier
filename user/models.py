...
class User(AbstractUser):
    ...
    propietario_cliente = models.ForeignKey(
        modelos_g_clientes.Cliente, on_delete=models.CASCADE, null=True, blank=True)
    propietario_mensajero = models.ForeignKey(
        modelos_g_mensajeros.Mensajeros, on_delete=models.CASCADE, null=True, blank=True)
